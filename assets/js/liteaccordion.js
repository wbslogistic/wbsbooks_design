...
;(function($) {
    ...
    var LiteAccordion = function(elem, options) {
        var defaults = {
            containerWidth : 825,                   // fixed (px)
            containerHeight : 300,                  // fixed (px)
            headerWidth : 200,                       // fixed (px)
        ...
        // core utility and animation methods
            core = {
                ...
                setStyles : function() {
                   ...
                   // console.log(maxheightitems(elem.find('ol li')));
                    elem
                    ...
                    //Load before
                    if(elem.find('ol').is(':hidden')){
                        elem.find('#preload').show();
                    }
                    // set slide heights
                    slides
                        .addClass('slide')
                ...
                maxheightitems : function(el){

                    var tallest = 0;
                    el.each(function() {

                        var height = el.css({height: '', 'min-height': ''}).height();
                ...
                setSlidePositions : function() {
                    ...
                    header.each(function(index) {
                        ...
                        $this
                            .css('left', left)
                            .css('width',settings.headerWidth+'px')
                            .next()
                                .css('width',slideWidth - offset + settings.headerWidth+'px')
                ...
                animSlide : function(triggerTab) {
                    ...
                    slides.removeClass('current').find('h2.selected').parent().addClass('current');
